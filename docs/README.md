...
- `03-shorts-spec.md` — 쇼츠 영상 스펙 (승인된 샘플 기준)
- `04-roadmap-sessions.md` — 2–4단계(쇼츠 렌더 → 승인 봇·자동 게시 → 현황판) 세션별 프롬프트, 완료 조건, 리스크
- `shorts-prototype.html` — 쇼츠 샘플 프로토타입. 브라우저로 열면 재생됨. Remotion 포팅 기준
